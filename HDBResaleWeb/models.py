...
#Additional features added
    ...
    cpi_adjusted_resale_price = db.Column(db.Integer, nullable=False)
    latitude = db.Column(db.Integer, nullable=False)
    longitude = db.Column(db.Integer, nullable=False)
    postal_district = db.Column(db.Integer, nullable=True)
    ...
    orchard_distance = db.Column(db.Float, nullable=False)
